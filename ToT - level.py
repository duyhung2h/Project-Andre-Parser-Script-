...
listEquipments = [
    ...
    Equipment('TB', "Tattered Boots", 448, 10, "Boots", "n/a_localArea", "GREEN"),  # Scout Cav
    Equipment('LB', "Leather Boots", 546, 20, "Boots", "n/a_localArea", "BLUE"),  # Light Cav
    Equipment('HB', "Headband", 825, 10, "Headwear", "n/a_localArea", "GREEN"),  # Amazon Warrior
    Equipment('LC', "Leather Cap", 725, 20, "Headwear", "n/a_localArea", "BLUE"),  # Jaguar Warrior
